...
import io.github.keep2iron.peach.creator.*
...
class DrawableCreator : AbstractCreator {
    ...
    override fun setup(): AbstractCreator = this
    ...
    override fun innerRadius(innerRadius: Int): ShapeCreator = apply { properties.innerRadius = innerRadius }
    override fun innerRadiusRatio(innerRadiusRatio: Float): ShapeCreator = apply { properties.innerRadiusRatio = innerRadiusRatio }
    override fun thickness(thickness: Int): ShapeCreator = apply { properties.thickness = thickness }
    override fun thicknessRatio(thicknessRatio: Float): ShapeCreator = apply { properties.thicknessRatio = thicknessRatio }
    override fun useLevelForRing(use: Boolean): ShapeCreator = apply { properties.useLevelForRing = use }

    // <corner>
    override fun cornerRadius(cornerRadius: Int) = apply { properties.cornerRadius = cornerRadius }

    override fun topLeftRadius(topLeftRadius: Int) = apply { properties.topLeftRadius = topLeftRadius }
    override fun topRightRadius(topRightRadius: Int) = apply { properties.topRightRadius = topRightRadius }
    override fun bottomRightRadius(bottomRightRadius: Int) = apply { properties.bottomRightRadius = bottomRightRadius }
    override fun bottomLeftRadius(bottomLeftRadius: Int) = apply { properties.bottomLeftRadius = bottomLeftRadius }
    override fun rounded() = apply { cornerRadius(Int.MAX_VALUE) }
    override fun cornerRadii(topLeftRadius: Int, topRightRadius: Int, bottomRightRadius: Int, bottomLeftRadius: Int) = apply {
    ...
    override fun gradientRadiusType(gradientRadiusType: Int) = apply { properties.gradientRadiusType = gradientRadiusType }
    override fun gradientRadius(gradientRadius: Float) = apply { properties.gradientRadius = gradientRadius }
    override fun gradientRadius(radius: Float, type: Int) = apply { gradientRadius(radius); gradientRadiusType(type) }
    override fun gradientRadiusInPixel(radius: Float) = apply { gradientRadius(radius); gradientRadiusType(DrawableProperties.RADIUS_TYPE_PIXELS) }
    override fun gradientRadiusInFraction(radius: Float) = apply { gradientRadius(radius); gradientRadiusType(DrawableProperties.RADIUS_TYPE_FRACTION) }
    ...
    override fun solidColorPressedWhenRippleUnsupported(color: Int?) = apply { solidColorPressedWhenRippleUnsupported = color }
    ...
    override fun solidColorStateList(colorStateList: ColorStateList) = apply { properties.solidColorStateList = colorStateList }
    ...
    override fun strokeColorStateList(colorStateList: ColorStateList) = apply { properties.strokeColorStateList = colorStateList }
    ...
    override fun degrees(fromDegrees: Float, toDegrees: Float) = apply { fromDegrees(fromDegrees).toDegrees(toDegrees) }
    override fun degrees(degrees: Float) = apply { fromDegrees(degrees).toDegrees(degrees) }
    override fun rotate(fromDegrees: Float, toDegrees: Float) = apply { rotate().fromDegrees(fromDegrees).toDegrees(toDegrees) }
    ...
    override fun scale(scaleWidth: Float, scaleHeight: Float) = apply { scale().scaleWidth(scaleWidth).scaleHeight(scaleHeight) }
    ...
    override fun rippleColorStateList(colorStateList: ColorStateList) = apply { properties.rippleColorStateList = colorStateList }
