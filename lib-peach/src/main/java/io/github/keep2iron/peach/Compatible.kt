...
internal fun resolveField(source: Class<*>, fieldName: String): Field {
...
internal fun resolveMethod(source: Class<*>, methodName: String, vararg parameterTypes: Class<*>): Method {
